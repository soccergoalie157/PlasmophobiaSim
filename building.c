...
void populateRooms(BuildingType* building) {
    ...
    // Building->rooms might be a linked list structure, or maybe just a node.
...
/*
  ...
  Purpose:   initialize the variables in a BuildingType structure
       in:   the BuildingType structure that needs to be initialized
...
/*
  ...
  Purpose:   Free the space allocated by the given BuildingType
       in:   the BuildingType that will be freed
   return:   No return value
*/
